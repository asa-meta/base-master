...
public class ExcelUtil {
     ...
     * @return
     */
    public ExcelUtil create(String filePath, String name) {
        //检测保存路劲是否存在，不存在则新建
    ...
    public ExcelUtil createSheetFillData(String sheetName, String[] titles, List<Object> dataList, WritableCellFormat format) throws WriteException {
        checkWorkbookIsNull();
     ...
     */
    public ExcelUtil createSheetSetTitle(String sheetName, String[] titles, WritableCellFormat format) throws WriteException {
        checkWorkbookIsNull();
     ...
     * @param format
     */
    public ExcelUtil fillStringData(List<List<String>> dataList, WritableCellFormat format) {
        checkSheetIsNull();
        ...
        for (int x = 1; x <= dataList.size(); x++) {
            ...
            for (int y = 0; y < datas.size(); y++) {
                try {
                    ...
                    int width = getStringLength(datas.get(y));
     ...
     * @param format
     */
    public ExcelUtil fillData(List<Object> dataList, WritableCellFormat format) {
        checkSheetIsNull();
