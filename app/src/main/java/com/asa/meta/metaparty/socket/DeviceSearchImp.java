...
public class DeviceSearchImp implements DeviceSearchService {
    ...
    public DeviceSearchImp(SearchCallback searchCallback) throws SocketException, UnknownHostException {
    ...
    public void startFeedback() {
        Observable.interval(1000, 1 * 1000, TimeUnit.MILLISECONDS)
