...
@Navigator.Name("smart-fragment")
public class SmartNavigator extends FragmentNavigator {
    ...
    public NavDestination navigate(@NonNull FragmentNavigator.Destination destination, @Nullable Bundle args,
        ...
        Fragment cacheFragment = mFragmentManager.findFragmentById(destination.getId());
    ...
    public static class Destination extends NavDestination {
         ...
         */
        @NonNull
        public final SmartNavigator.Destination setClassName(@NonNull String className) {
    ...
    public static final class Extras implements Navigator.Extras {
        ...
        public static final class Builder {
             ...
             */
            @NonNull
            public SmartNavigator.Extras.Builder addSharedElements(@NonNull Map<View, String> sharedElements) {
             ...
             */
            @NonNull
            public SmartNavigator.Extras.Builder addSharedElement(@NonNull View sharedElement, @NonNull String name) {
             ...
             */
            @NonNull
            public SmartNavigator.Extras build() {
                return new SmartNavigator.Extras(mSharedElements);
            }
        }
    }
}
