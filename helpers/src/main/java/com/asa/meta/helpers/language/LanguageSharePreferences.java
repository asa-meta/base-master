...
public class LanguageSharePreferences {
    ...
    public LanguageSharePreferences(Context context) {
        mSharedPreferences = context.getSharedPreferences(SP_NAME, Context.MODE_PRIVATE);
    }

    public static LanguageSharePreferences getInstance(Context context) {
        if (instance == null) {
            synchronized (LanguageSharePreferences.class) {
                if (instance == null) {
                    instance = new LanguageSharePreferences(context);
                }
            }
        }
        return instance;
